...
def main(args):
	...
	with tf.variable_scope('input_reader'):
		data_set = continual_data_reader.dataset(
			...
			is_training=False,
			shuffle=False,
			r_proxy = args.fusion == 'input_fusion'
		)
		if args.fusion == 'input_fusion':
			left_img_batch, right_img_batch, gt_image_batch, px_image_batch, r_px_image_batch, real_width = data_set.get_batch()
		else:
	...
	with tf.variable_scope('model'):
		...
		net_args['fusion'] = args.fusion # fusion arg
		net_args['left_disp'] = px_image_batch # fusion arg
		net_args['right_disp'] = r_px_image_batch # fusion arg
