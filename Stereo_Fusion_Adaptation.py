...
from Data_utils import fusion_data_reader,weights_utils,preprocessing
...
def main(args):
	...
	with tf.variable_scope('input_reader'):
		data_set = fusion_data_reader.dataset(
			args.list,
			batch_size = 1,
		...
		inputs={
			...
			'sparse_proxy':s_px_batch,
			'sparse_proxy_r': s_px_r_batch,
	...
	with tf.variable_scope('model'):
		...
		net_args['proxy_l'] = px_image_batch
		net_args['s_proxy'] = s_px_batch
		net_args['s_proxy_r'] = s_px_r_batch
